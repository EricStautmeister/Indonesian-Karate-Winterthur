				...
				<form className={classes.form} onSubmit={(event) => event.preventDefault()}>
					...
					<div className={classes.fields}>
						<SimpleGrid cols={2} breakpoints={[{ maxWidth: 'sm', cols: 1 }]}>
							...
							<TextInput label="Email" placeholder="abc@beispiel.com" required />
						</SimpleGrid>

						<TextInput mt="md" label="Betreff" placeholder="Betreff" required />

						<Textarea
							mt="md"
							label="Deine Nachricht"
							placeholder="Bitte geben Sie alle relevanten Informationen an"
							minRows={3}
							required
						/>
